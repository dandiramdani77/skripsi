...
@section('title')
    Hitung Bullwhip Effect Setelah Peramalan
@endsection
...
@section('breadcrumb')
    @parent
    <li class="active">Hitung Bullwhip Effect Setelah Peramalan</li>
@endsection
    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <form action="{{ route('hitung_ramal.beUpdate') }}" method="post">
                            @csrf
                            <button type="submit" class="btn btn-primary">Check Bullwhip Effect</button>
                        </form>
                    </div>
                    <div class="col-lg-4">
                        <form action="{{ route('bullwhipeffect2.store') }}" class="form-order" method="post">
                            @csrf
...
<script>
    ...
    $(function () {
        ...
        table = $('.table-order').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '{{ route('hitung_ramal.data', $id_order) }}',
            },
            columns: [
    ...
    function tambahKategori() {
        $.post('{{ route('hitung_ramal.store') }}', $('.form-kategori').serialize())
            .done(response => {
                table.ajax.reload();
            })
            .fail(errors => {
